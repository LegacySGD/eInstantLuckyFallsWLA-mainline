...
public class LuckyFallsWLAWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(LuckyFallsWLAWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/LuckyFallsWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/LuckyFallsWLAIW/InitOutcome.xml").getDocumentElement();
